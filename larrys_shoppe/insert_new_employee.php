<!-- Larry's Shoppe - insert_new_employee.php 
	Jacob Baynes
...
// Declare variables for errors and for employee info
...
{
	//sql insert command
	$sql = "INSERT INTO employees(first_name, last_name, street, city, state, zip, phone, email)
	...
	if (isset($_POST['submit'])) 
	{
		...
		{
			$f_name_error = " Employee File Created";
		}
		else
		{
...
<div class="page-header" style="background-color: #330000; text-align: center;";><img class="img-thumbnail" src="images/employee_photo.jpg" alt="Larry's Shoppe Nav Bar Photo" style="margin: auto; height: 40%; width: 40%;"><h1 style="color: white">Create New Employee</h1></div>
