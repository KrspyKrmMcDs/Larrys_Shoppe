...
$cust_id_error = $f_name_error = $l_name_error = $street_error = $city_error = $state_error = $zip_error = $phone_error = $email_error = "";
$customer_id = $firstName = $lastName = $street = $city = $state = $zip = $phone = $email = "";
...
if ($firstName && $lastName && $street && $city && $state && $zip && $phone && $email) 
{
	...
	if (isset($_POST['submit'])) 
	{
		...
		{
			$f_name_error = " Customer File Modified";
		}
		else
		{
...
<div class="page-header" style="background-color: #000000; text-align: center;";><img class="img-thumbnail" src="images/header_photo.jpg" alt="Larry's Shoppe Nav Bar Photo" style="margin: auto; height: 60%; width: 60%;"><h1 style="color: white">Modify Customer Information</h1></div>
