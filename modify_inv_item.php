<!-- Larry's Shoppe - modify_inv_item.php 
	Jacob Baynes
...
$item_id_error = $desc_error = $price_error = $quantity_error = $vendor_id_error = "";
$item_id = $description = $price = $quantity = $vendor_id = "";
...
if ($item_id && $description && $price && $quantity && $vendor_id) 
{
	//sql insert command
	$sql = "UPDATE inventory
	SET description='$description', price='$price', quantity_in_stock='$quantity', vendor_id='$vendor_id'
	...
	if (isset($_POST['submit'])) 
	{
		...
		{
			$desc_error = " Inventory File Modified";
		}
		else
		{
...
<div class="page-header" style="background-color: #001a00; text-align: center;";><img class="img-thumbnail" src="images/inventory_photo.png" alt="Larry's Shoppe Nav Bar Photo" style="margin: auto; height: 60%; width: 60%;"><h1 style="color: white">Modify Inventory Item</h1></div>
